...
local getcustomassets = {
	['10abcdV4/assets/rise/slice.png'] = 'rbxasset://risesix/slice.png',
	['10abcdV4/assets/rise/blur.png'] = 'rbxasset://risesix/blur.png',
...
local function writeFont()
	...
	writefile('10abcdV4/assets/rise/risefont.json', httpService:JSONEncode({
		name = 'ProductSans',
		faces = {
			{style = 'normal', assetId = getcustomasset('10abcdV4/assets/rise/SF-Pro-Rounded-Light.otf'), name = 'Light', weight = 300},
			{style = 'normal', assetId = getcustomasset('10abcdV4/assets/rise/SF-Pro-Rounded-Regular.otf'), name = 'Regular', weight = 400},
			{style = 'normal', assetId = getcustomasset('10abcdV4/assets/rise/SF-Pro-Rounded-Medium.otf'), name = 'Medium', weight = 500},
			{style = 'normal', assetId = getcustomasset('10abcdV4/assets/rise/Icon-1.ttf'), name = 'Icon1', weight = 600},
			{style = 'normal', assetId = getcustomasset('10abcdV4/assets/rise/Icon-3.ttf'), name = 'Icon3', weight = 800}
		}
	}))
	return getcustomasset('10abcdV4/assets/rise/risefont.json')
end
		...
		for i, v in mainapi.Modules do
			if v.Enabled or table.find(found, i) then
				...
				if interfacebar.Enabled then
					...
					holderline.Image = getcustomasset('10abcdV4/assets/rise/slice.png')
