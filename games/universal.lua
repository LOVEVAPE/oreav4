...
local hash = loadstring(downloadFile('10abcdV4/libraries/hash.lua'), 'hash')()
local prediction = loadstring(downloadFile('10abcdV4/libraries/prediction.lua'), 'prediction')()
entitylib = loadstring(downloadFile('10abcdV4/libraries/entity.lua'), 'entitylibrary')()
local whitelist = {
	alreadychecked = {},
	customtags = {},
...
run(function()
	...
	function whitelist:update(first)
		local suc = pcall(function()
			...
			whitelist.textdata = game:HttpGet('https://raw.githubusercontent.com/LOVEVAPE/oreav4/'..commit..'/PlayerWhitelist.json', true)
		end)
		...
		if not first or whitelist.textdata ~= whitelist.olddata then
			if not first then
				whitelist.olddata = isfile('10abcdV4/profiles/whitelist.json') and readfile('10abcdV4/profiles/whitelist.json') or nil
			end
			...
			if whitelist.textdata ~= whitelist.olddata then
				...
				pcall(function()
					writefile('10abcdV4/profiles/whitelist.json', whitelist.textdata)
				end)
			end
...
run(function()
	...
	local function Added(ent)
		...
		arrow.Visible = false
		arrow.Image = getcustomasset('10abcdV4/assets/new/arrowmodule.png')
...
run(function()
	...
	Radar = vape:CreateOverlay({
		Name = 'Radar',
		Icon = getcustomasset('10abcdV4/assets/new/radaricon.png'),
	...
	ChatSpammer = vape.Categories.Utility:CreateModule({
		...
		Function = function(callback)
			if callback then
				...
				local ind = 1
				repeat
					local message = (#Lines.ListEnabled > 0 and Lines.ListEnabled[math.random(1, #Lines.ListEnabled)] or '10abcdV4 on top')
